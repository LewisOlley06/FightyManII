...
loadSound("menu_theme", "/sounds/menu.wav")
loadSound("bad_ending", "/sounds/BadEnding.wav")
...
loadSound("stage_select", "/sounds/stage_select.wav")
loadSound("stage_one", "/sounds/Stage1.wav")
loadSound("stage_two", "/sounds/Stage2.wav")
loadSound("stage_three", "/sounds/Stage3.wav")
loadSound("stage_four", "/sounds/Stage4.wav")
loadSound("boss_four", "/sounds/Boss4.wav")
loadSound("stage_five_a", "/sounds/Stage5a.wav")
loadSound("stage_five_b", "/sounds/Stage5b.wav")
loadSound("stage_six", "/sounds/Stage6.wav")
loadSound("Boss_Final", "/sounds/Boss_Final.wav")
loadSound("leaderboard", "/sounds/leaderboard.wav")
loadSound("button", "/sounds/button.mp3")
loadSound("level_complete", "/sounds/level_complete.wav")
loadSound("bad", "/sounds/FX/declined.mp3")
loadSound("FinalBossIntro", "/sounds/FinalBossIntro.wav")
loadSound("FinalBossLoop1", "/sounds/FinalBossLoop1.wav")
loadSound("FinalBossLoop2", "/sounds/FinalBossLoop2.wav")
...
scene("stage_four", async (playerTag) => {
    await levelInit(playerTag, "Stage Four", "boss_four", ["stage_four_bg"])
    currentRound = 4
